...
from tools.attention import SE_Block
...
class NestFuse_light2_nodense(nn.Module):
    ...
    def __init__(self, nb_filter, input_nc=1, output_nc=1, deepsupervision=False):
        ...
        self.funsion = cbam(nb_filter)
        
        self.gap = GAP2D()
        
        self.fc = nn.Linear(dims[1], 2) 
    ...
    def forward(self, input):
        ...
        f_en = self.funsion([x1_0, x2_0], [x1_dem, x2_dem])
        
        # x1 = self.down1(f_en.permute(0, 2, 3, 1))
